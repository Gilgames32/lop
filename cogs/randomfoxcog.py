...
class RandomFoxCog(commands.Cog):
    ...
    @app_commands.choices(
        animal=[
            app_commands.Choice(name="African Wild dog", value="chi"),
            ...
            app_commands.Choice(name="Ferret", value="dook"),
            ...
            app_commands.Choice(name="Lion", value="leo"),
            ...
            app_commands.Choice(name="Opossum", value="poss"),
            app_commands.Choice(name="Otter", value="ott"),
            app_commands.Choice(name="Manul", value="manul"),
            app_commands.Choice(name="Pine Marten", value="marten"),
            ...
            app_commands.Choice(name="Shiba Inu", value="shiba"),
            app_commands.Choice(name="Skunk", value="skunk"),
    ...
    async def random_animals(self, interaction: discord.Interaction, animal: str):
        await interaction.response.defer()
        try:
            img = requests.get(f"https://api.tinyfox.dev/img?animal={animal}").content
            await interaction.followup.send(
                file=discord.File(io.BytesIO(img), f"{animal}.png")
            )
        except Exception as e:
            await interaction.followup.send(str(e))
